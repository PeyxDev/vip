...
wget -O /usr/local/bin/ws "http://raw.githubusercontent.com/PeyxDev/vip/main/fooder/sshws/ws"
...
wget -O /usr/local/bin/ws-ovpn "http://raw.githubusercontent.com/PeyxDev/vip/main/fooder/sshws/ws"
